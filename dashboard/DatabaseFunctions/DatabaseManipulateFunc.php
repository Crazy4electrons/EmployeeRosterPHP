     * ______________________________________________________________________________________________________
     <?php
        class Database
        {
             ...
             *  ----------------------------------------- Table Structure -----------------------------------------------
             *  |_______________________________________| Users|________________ _____________________________________| 
             *  |user_id[INT]|username[txt]|first_name[txt]|last_name[txt]|email[txt]|password[txt]|table_access[json]|-->
             *   ->|always updated||optional: updated using updateUserData() method|<-_____
             *  -->|last_login[datetime]||geo_location[txt] | extra_data[json] |
             */
            public function createUser($username, $first_name, $last_name, $email, $password, $access = "") //done!
            {
                ...
                VALUES ($username,$first_name,$last_name,$email,$derivedPassword,$access);";
                        try {
                            ...
                            $this->updateUserMetadata($username, 0);
                            return true;
                        } catch (PDOException $error) {
